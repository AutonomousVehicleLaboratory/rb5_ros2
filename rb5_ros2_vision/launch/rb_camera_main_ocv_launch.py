...
def generate_launch_description():
    ...
    topic_name_prefix = DeclareLaunchArgument(
        "topic_name_prefix", default_value=TextSubstitution(text="camera")
    )
    image_compress = DeclareLaunchArgument(
        "image_compress", default_value=TextSubstitution(text="fal)
    )
